...
interface ThreatAction {
  ...
  effects?: string;
  notes?: string;
  successText?: string; // "Upon a successful hit" text
  autoGenerated: boolean;
  source: string;
}

interface ThreatFeature {
  id: string;
  name: string;
  description: string;
...
const ATTACK_FAMILIES = ["Melee", "Ranged", "Mental", "Elemental", "Energy", "Special"];
...
export default function Step8_Actions() {
  ...
  const [actions, setActions] = useState<ThreatAction[]>([]);
  const [features, setFeatures] = useState<ThreatFeature[]>([]);
  ...
  const addAction = () => {
    ...
    const newAction: ThreatAction = {
      ...
      attackFamily: actionForm.attackFamily,
    ...
    setActionForm({ type: "Attack", autoGenerated: false, source: "Custom" });
  };
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {action.attackFamily && (
                            <Badge variant="outline">{action.attackFamily}</Badge>
                          )}
                        </div>
              ...
              <div className="grid gap-4">
                ...
                {actionForm.type === "Attack" && (
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                      <Label htmlFor="action-family">Attack Family</Label>
                      <Select 
                        value={actionForm.attackFamily} 
                        onValueChange={(value) => setActionForm(prev => ({ ...prev, attackFamily: value }))}
                      >
                        <SelectTrigger data-testid="select-attack-family">
